...
import top.takefly.core.service.AddressService;
...
public class AddressServiceImpl implements AddressService {
	...
	public PageResult findPage(int pageNum, int pageSize) {
		...
		Page<Address> page=   (Page<Address>) addressDao.selectByExample(null);
	...
	public PageResult findPage(Address address, int pageNum, int pageSize) {
		...
		Page<Address> page= (Page<Address>)addressDao.selectByExample(example);		
		return new PageResult((int)page.getTotal(), page.getResult());
	}
