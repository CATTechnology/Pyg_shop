...
public class ItemServiceImpl implements ItemService {
	...
	public PageResult findPage(int pageNum, int pageSize) {
		...
		Page<Item> page=   (Page<Item>) itemDao.selectByExample(null);
	...
	public PageResult findPage(Item item, int pageNum, int pageSize) {
		...
		Page<Item> page= (Page<Item>)itemDao.selectByExample(example);		
		return new PageResult((int)page.getTotal(), page.getResult());
	}

	@Override
	public List<Item> findByPrimaryKey(Long goodsId) {
