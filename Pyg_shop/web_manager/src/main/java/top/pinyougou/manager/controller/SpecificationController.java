...
public class SpecificationController {
	...
	/**
	 * 增加
	 * @param addSpecification 组合参数specification和specificationOption
	 * @return
	 */
	@RequestMapping("/add")
	public Result add(@RequestBody AddSpecification addSpecification){
		try {
			specificationService.add(addSpecification);
	...
	/**
	 * 修改
	 * @param addSpecification //是Specification和SpecificationOption的组合
	 * @return
	 */
	@RequestMapping("/update")
	public Result update(@RequestBody AddSpecification addSpecification){
		try {
			specificationService.update(addSpecification);
	...
	@RequestMapping("/selectSpecificationToTypeTemplate")
	public List<Map> selectBrandToTypeTemplate() {
		return specificationService.selectSpecificationToTypeTemplate();
	}
}
